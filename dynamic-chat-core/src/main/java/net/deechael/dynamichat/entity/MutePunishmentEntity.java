...
public class MutePunishmentEntity implements Punishment {
    ...
    public MutePunishmentEntity(String id, String username, String operator, String startDate, String endDate, boolean unbanned, String reason) {
        this.id = id;
